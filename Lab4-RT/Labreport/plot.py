...
params4, cov4 = curve_fit(expo,T[100:],R1[100:],p0=[1,1,1])
...
ax.plot(TT, metals(TT,*params1), 'b-', label='Linear fit')
ax.plot(TT[500:], expo(TT[500:],*params4), 'r-', label='Exponential fit')
#ax.plot(TT, gaussian(TT, *params), '-', color='#EC0000', label='Gaussian fit') #label=r'Fit $B(z) = az^4 + bz^3 + cz^2 + dz + e$')
ax.set_xlabel(r'$T \:/\: \si{\kelvin}$')
...
ax.plot(TT, metals(TT,*params2), 'b-', label='Linear fit')
#ax.plot(TT, gaussian(TT, *params), '-', color='#EC0000', label='Gaussian fit') #label=r'Fit $B(z) = az^4 + bz^3 + cz^2 + dz + e$')
ax.set_xlabel(r'$T \:/\: \si{\kelvin}$')
ax.set_ylabel(r'$R \:/\: \si{\ohm}$')
leg1 = ax.legend(loc='best', fancybox=False, prop={'size':16}, edgecolor='k')
...
ax.plot(TT, metals(TT,*params3), 'b-', label='Linear fit')
#ax.plot(TT, gaussian(TT, *params), '-', color='#EC0000', label='Gaussian fit') #label=r'Fit $B(z) = az^4 + bz^3 + cz^2 + dz + e$')
ax.set_xlabel(r'$T \:/\: \si{\kelvin}$')
ax.set_ylabel(r'$R \:/\: \si{\ohm}$')
leg1 = ax.legend(loc='best', fancybox=False, prop={'size':16}, edgecolor='k')
